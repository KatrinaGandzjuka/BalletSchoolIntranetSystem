...
<!--
Šis HTML dokuments nodrošina funkcionalitāti numura dzēšanai baletskolas sistēmā.
Dokuments ietver navigācijas joslu ar saitēm uz dažādām lapām un apstiprinājuma formu numura dzēšanai, kurā lietotājs var apstiprināt vai atcelt dzēšanas darbību.
-->
<!DOCTYPE html>
<html lang="lv">
<head>
...
<body>
    ...
    <div class="container">
        <div class="row pt-5">
            ...
            <div class="col-md-4">
                <div class="card">
                    <h4 class="card-header">Izdzēst šo numuru?</h4>
                    <div class="card-body">
                        <a href="{{ url('/viewNumurs')}}" class="btn btn-sm btn-primary">Nē</a>
                        <a href="{{ url('deleteNumursData'.$NumursID)}}" class="btn btn-sm btn-danger">Jā</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4"></div>
