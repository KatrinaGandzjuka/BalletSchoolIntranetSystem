<!--
Šis HTML dokuments nodrošina informācijas par audzēkni pārvaldību baletskolas sistēmā.
Dokuments ietver navigācijas joslu ar saitēm uz dažādām lapām un dažādām sadaļām, kas attēlo informāciju par audzēkni, grupām, pedagogiem, vecākiem, kostīmiem un koncertiem.
  ...
  <body>
    ...
    <div class="container">
      <div class="row pt-5">
        ...
        <div class="col-md-4">
          <div class="card">
            <h4 class="card-header">Izdzēst šo grupu?</h4>
            <div class="card-body">
              <a href="{{ url('/viewGrupas')}}" class="btn btn-sm btn-primary">Nē</a>
              <a href="{{ url('deleteGrupasData'.$GrupasNosaukums)}}" class="btn btn-sm btn-danger">Jā</a>
            </div>
          </div>
        </div>
        <div class="col-md-4"></div>
